...
This is mainly repeating the steps from before for creating the repository and the local folders. After cloning the repo into the local folder one can just copy-paste the files from the existing projects into the newly created folder.
